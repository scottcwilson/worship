...
$define = [
    ...
    'IMAGE_CC_ENABLED_VISA' => zen_image($template->get_template_dir('t_visa.jpg', DIR_WS_TEMPLATE, $current_page_base, 'images/icons') . '/' . 't_visa.jpg'),
    'IMAGE_CC_ENABLED_MC' => zen_image($template->get_template_dir('t_MC.jpg', DIR_WS_TEMPLATE, $current_page_base, 'images/icons') . '/' . 't_MC.jpg'),
